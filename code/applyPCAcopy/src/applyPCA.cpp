...
void applyPCA()
{
	/// make the RAW to JPGs & pfms
    	...
    	string filepath = "/big/temp/hanli/data/moredata/";
...
///////////////////////////////////////////////////////////////////////
    ...
    int expolist[4] = { 20, 7, 5, 3 };
//    vector<int> darkindex = {57, 60, 61, 137, 138, 139, 156, 164, 165, 166, 167, 168, 169, 170, 171, 172, 194};
    int a[17] = {57, 60, 61, 137, 138, 139, 156, 164, 165, 166, 167, 168, 169, 170, 171, 172, 194};
    vector<int> darkindex(a, a+17);
	
    string pcacurvepath = filepath + "pcacurveexpo/";
    ...
    for ( int i = imgStart; i < imgEnd; i++ )
    {
     ...
     for( int expoindex = 0; expoindex < 1; expoindex++)
     {
	...
	{
	   if( std::find(darkindex.begin(), darkindex.end(), curveindex+1)!= darkindex.end())
	   {
