...
datapath = '/big/temp/hanli/data/moredata/zztestscene/croptest/'
cropdatatxtpath = '/big/temp/hanli/data/moredata/zzcropdata/croppcacurvetxt/'
cropdatapath = '/big/temp/hanli/data/moredata/zzcropdata/croppcacurve/'
...
#    imgpath = datapath + imgname + '.png';
	...
	img = Image.open(imgpath)                
        ...
        if nonzeroHist >= selectNbinsfrombins:
