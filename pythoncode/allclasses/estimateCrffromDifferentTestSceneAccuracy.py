...
trainlist = '/home/hanli/caffe/examples/crf6resnet/list.txt'
...
#now = f.read()
f = os.popen('/home/hanli/caffe/build/tools/caffe test -model /home/hanli/caffe/examples/crf6resnet/deploywithAccuracy.prototxt -weights /big/temp/hanli/data/moredata/datasnapshotcopy/snapshot0117resnet_accuracy074best/_iter_30000.caffemodel -iterations 8075')
now = f.read()
