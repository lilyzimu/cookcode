...
#now = f.read()
f = os.popen('/home/hanli/caffe/build/tools/caffe test -model /home/hanli/caffe/examples/crf10lessclass/deploywithAccuracyclass31.prototxt -weights /big/temp/hanli/data/moredata/datasnapshotcopy/snapshot0122resent_31classes/_iter_100000.caffemodel -iterations 1966')
now = f.read()
