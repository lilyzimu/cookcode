...
trainlist = '/big/temp/hanli/data/moredata/zzcropdata/test.txt'
...
testpngpath = '/home/hanli/caffe/examples/crf10lessclass/list.txt'
plotoutpath = '/big/temp/hanli/data/moredata/zzplotout/31classes/plotoutTestScene/'
curveWithImagepath = '/big/temp/hanli/data/moredata/zzplotout/31classes/curveWithTestImagePlotOut/'
...
curvepngpath = wholepath + 'zzcropdata/croppcacurve/'
...
#    cropcurvename = 'scene1smallcurve1CropWin0.png'
    ...
    f = os.popen('/home/hanli/caffe/build/tools/caffe test -model /home/hanli/caffe/examples/crf10lessclass/deployclass31.prototxt -weights /big/temp/hanli/data/moredata/datasnapshotcopy/snapshot0122resent_31classes/_iter_100000.caffemodel -iterations 1') 
    now = f.read()
